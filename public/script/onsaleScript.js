...
for (const item of parsedList) {
    ...
    if (item.bidders.length != 0) {
        bidNum.textContent = `응찰 ${item.bidders.length}`;
    ...
    infoDiv.append(infoHeader, nullDiv, newName, newId, newPrice, periodDate, to_detail);
